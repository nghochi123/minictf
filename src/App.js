...
const qr = importAll(require.context('./Resources/qr-codes', false, /\.(png|jpe?g|svg)$/));
...
function Login() {
  ...
  return (
    <div class="pageContainer">
      ...
      <div>
        <p class="hide">Right Click -{">"} Inspect to uncover the username and password!</p>
      </div>
      <p class="footer">2</p>
      <react-comment>
  ...
  return (
    <div class="pageContainer">
      ...
      <p style={{display: "flex"}}>
        Hello Agent James, your task is hidden inside these 3 manuals to keep it hidden from foreign spies.
        The numbers will guide your way. Good luck and god speed.
      </p>
      ...
      <div class="verticalContainer">
        ...
        <p class="hide">Right click -{">"} properties -{">"} details!</p>
      </div>
      <div class="verticalContainer">
        <img src={images['manual_gamma.jpg']} alt="gamma" class="image"/>
        <p class="hide">https://pinetools.com/adjust-gamma-image -{">"} adjust gamma levels!</p>
      </div>
      <p class="footer" style={{position: "relative"}}>5</p>
    </div>
  )
}
...
function Mission() {
  ...
  const onSubmit = (e) => {
    ...
    if (!button1 && button2 && button3 && !button4 && button5 && !button6 && !button7 && !button8 && button9) {
      navigate("../6cbf40494f64db7248d7d4d7737f772d6f80941cb93389b49d4321487328acb8")
    } else {
      setWrong(true)
    }
  };
  ...
  return (
    <div class="pageContainer">
      ...
      <br/>
      <button style={styles} name="submit" onClick={(e) => onSubmit(e)}>Submit</button>
